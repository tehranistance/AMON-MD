...
// AI Chat - Shizo API
export const chatAI = async (text) => {
    try {
...
// Instagram Download
export const igDownload = async (url) => {
    try {
...
// TikTok Download
export const tiktokDownload = async (url) => {
    try {
...
// Translate
export const translate = async (text, to = 'en') => {
    try {
...
// Song Download APIs
export const getIzumiDownloadByUrl = async (youtubeUrl) => {
    const apiUrl = `https://izumiiiiiiii.dpdns.org/downloader/youtube?url=${encodeURIComponent(youtubeUrl)}&format=mp3`;
    const res = await tryRequest(() => axios.get(apiUrl, AXIOS_DEFAULTS));
    if (res?.data?.result?.download) return res.data.result;
    throw new Error('Izumi youtube returned no download');
};

export const getIzumiDownloadByQuery = async (query) => {
...
export const getYupraDownloadByUrl = async (youtubeUrl) => {
...
export const getOkatsuDownloadByUrl = async (youtubeUrl) => {
...
export const getEliteProTechDownloadByUrl = async (youtubeUrl) => {
...
export const getEliteProTechVideoByUrl = async (youtubeUrl) => {
...
// Video Download APIs
export const getYupraVideoByUrl = async (youtubeUrl) => {
...
export const getOkatsuVideoByUrl = async (youtubeUrl) => {
...
// TikTok Download API
export const getTikTokDownload = async (url) => {
...
export const screenshotWebsite = async (url) => {
    try {
